        ...
        <Row style={{marginTop: '50px'}}>
          ...
          <Col xs={6}>
            ...
            <Row className="justify-content-md-center">
              ...
              <Button variant="primary" style={{borderRadius: '20px'}} onClick={() => {setIsLanding(false);}}>
                <span style={{marginLeft: '60px'}}> </span>
                {'Start Tabbing '}
                <img src={ArrowTipLightIcon} height={15} alt="little arrow icon" style={{marginLeft: '40px'}}/>
              </Button>
            </Row>
          </Col>
        </Row>
